...
<nav class="navbar navbar-expand-lg bg-info">
    <div class="container-fluid ">
        <a class="navbar-brand" href="#">YEAR FACTOIDS</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <?php if (is_logged_in()) : ?>
                    <li class="nav-item bg-light"><a class="nav-link" href="<?php echo get_url('home.php'); ?>">Home</a></li>
                    ...
                    <li class="nav-item bg-light"><a class="nav-link" href="<?php echo get_url('unclaimed_years.php'); ?>">Unclaimed Years</a></li>
                <?php endif; ?>
                <?php if (!is_logged_in()) : ?>
                    <li class="nav-item bg-light"><a class="nav-link" href="<?php echo get_url('login.php'); ?>">Login</a></li>
                    <li class="nav-item bg-light"><a class="nav-link" href="<?php echo get_url('register.php'); ?>">Register</a></li>
                <?php endif; ?>
                ...
                <?php endif; ?>
                <?php if (is_logged_in()) : ?>
                    <li class="nav-item bg-light"><a class="nav-link" href="<?php echo get_url('logout.php'); ?>">Logout</a></li>
                <?php endif; ?>
            </ul>
        </div>
    </div>
